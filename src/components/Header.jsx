    ...
    >
      <div className="max-w-375 mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:flex lg:items-center lg:gap-8">
          ...
          <Link
            to="/contact-us"
            className="cursor-pointer text-white rounded-full accent px-10 py-[18.5px] bg-linear-90 from-primary to-accent hover:bg-linear-270 transition duration-300 uppercase"
          >
            Contact us
          </Link>
        </div>
